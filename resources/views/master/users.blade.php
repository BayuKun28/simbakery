                        ...
                        <table id="mytable" class="table border display table-bordered table-striped no-wrap">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="col col-md-3 text-center">Nama</th>
                                    <th class="col col-md-2 text-center">username</th>
                                    <th class="col col-md-3 text-center">Email</th>
                                    <th class="col col-md-1 text-center">Created</th>
