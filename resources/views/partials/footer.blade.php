         ...
         <ul class="mb-0">
             <li class="pb-7">
                 <div class="d-flex align-items-center">
                     <img src="{{ asset('modern/') }}/dist/images/products/product-1.jpg" width="95" height="75"
             ...
             <li class="pb-7">
                 <div class="d-flex align-items-center">
                     <img src="{{ asset('modern/') }}/dist/images/products/product-2.jpg" width="95" height="75"
                         class="rounded-1 me-9 flex-shrink-0" alt="" />
                     <div>
                         <h6 class="mb-1">Supreme toys cooker</h6>
                         <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
             ...
             <li class="pb-7">
                 <div class="d-flex align-items-center">
                     <img src="{{ asset('modern/') }}/dist/images/products/product-3.jpg" width="95" height="75"
                         class="rounded-1 me-9 flex-shrink-0" alt="" />
                     <div>
                         <h6 class="mb-1">Supreme toys cooker</h6>
                         <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
     ...
     <div class="offcanvas-body p-4">
         <div class="theme-option pb-4">
             ...
             <div class="d-flex align-items-center gap-3 my-3">
                 <a href="javascript:void(0)" onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style.min.css')"
                     class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                     <i class="ti ti-brightness-up fs-7 text-primary"></i>
                     <span class="text-dark">Light</span>
                 </a>
                 <a href="javascript:void(0)"
                     onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-dark.min.css')"
                 ...
                 <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style.min.css')"
                     ...
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-aqua.min.css')"
                     ...
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-purple.min.css')"
                     ...
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-green.min.css')"
                     ...
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-cyan.min.css')"
                     ...
                     <li
                         ...
                         <a href="javascript:void(0)"
                             ...
                             onclick="toggleTheme('{{ asset('modern/') }}/dist/css/style-orange.min.css')"
 ...
 <script src="{{ asset('modern/') }}/dist/libs/datatables.net/js/jquery.dataTables.min.js"></script>
 @yield('addjs')
 {{-- <script>
     $(document).ready(function() {
         $('.uang').mask('000.000.000.000.000,00', {
             reverse: true
         });
         $('.persen').mask('000', {
             reverse: true
         ...
         $('.angka').mask('0000000000000000000', {
             reverse: true
         });
     });
 </script> --}}
